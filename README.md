...
All devices are running software versions that are "reasonably" recent; no snapshots (too much unnecessary drama there). RCs (release candidates) are fine as long as I'm not an early adopter and the major showstopping issues have already been sorted. I'm running OpenWrt 22.03.0-rc6 (first released on 1 August 2022) and OPNsense 22.7.2-amd64 (first released on 17 August 2022), and I apply and test updates where available on a weekly basis.
